...
exports.Insektenschutzrollo = class Insektenschutzrollo {

    constructor(page) {
        this.page = page;
    }

    async configureInsektenschutzrollo(testcase) {
        ...
        // set Farbe
        // await this.page.getByText(value).first().waitForTimeout(3000);
        ...
        // set Vorrichtung
        await this.page.locator('span').getByText(testcase.vorrichtung).first().click();
        ...
        await this.page.getByText(/In den Warenkorb/).first().click();
